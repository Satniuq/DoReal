...
OUT_DOT = os.path.join(OUT_DIR, "subgrafo_epistemologia.dot")
OUT_GRAPHML = os.path.join(OUT_DIR, "subgrafo_epistemologia.graphml")
OUT_RESUMO = os.path.join(OUT_DIR, "subgrafo_epistemologia_resumo.txt")
...
def resumo(g):
    ...
    return f"""SUBGRAFO EPISTEMOLOGIA
...
def main():
    ...
    print("Subgrafo Epistemologia gerado com sucesso.")
