...
OUT_DOT = os.path.join(OUT_DIR, "subgrafo_etica.dot")
OUT_GRAPHML = os.path.join(OUT_DIR, "subgrafo_etica.graphml")
OUT_RESUMO = os.path.join(OUT_DIR, "subgrafo_etica_resumo.txt")
...
def main():
    ...
    print("Subgrafo Ética gerado com sucesso.")
