...
def gerar_manuscrito_sintese(caminho_dados, caminho_saida):
    try:
    ...
    with open(caminho_saida, 'w', encoding='utf-8') as f:
        f.write("============================================================\n")
        f.write("        MANUSCRITO DE SÍNTESES – ONTOLOGIA TOTAL             \n")
        ...
        for bloco in [
            ...
            if bloco not in conteudo_organizado:
                continue
            ...
            subs_ordenados = sorted(
                conteudo_organizado[bloco].items(),
    ...
    print(f"O ficheiro '{caminho_saida}' contém apenas sínteses ontológicas.")

# Execução
gerar_manuscrito_sintese('Classificados_Final.json', '02_03_01_MANUSCRITO_SINTESE.txt')
