...
def gerar_manuscrito_final_v4(caminho_dados, caminho_saida):
    ...
    def obter_nivel(p):
        # Aceder ao novo caminho conforme a tua estrutura
        grau = p.get('grau_de_integracao_ontologica', {})
        return grau.get('nivel', 0)

    with open(caminho_saida, 'w', encoding='utf-8') as f:
        f.write("============================================================\n")
        f.write("    MANUSCRITO TAXONÓMICO FINAL (ORDENADO POR NÍVEL)       \n")
        f.write("============================================================\n\n")
        ...
        if sobras:
            f.write(f"\n\n{'#'*80}\n RESÍDUOS NÃO MAPEADOS (AUDITORIA TAXONÓMICA)\n{'#'*80}\n")
...
if __name__ == "__main__":
    gerar_manuscrito_final_v4('Classificados_Final.json', 'MANUSCRITO_REVISADO_V4.txt')