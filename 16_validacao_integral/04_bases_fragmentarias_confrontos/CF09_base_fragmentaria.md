# CF09 — Base fragmentária reaberta
...
Quanto a ação e liberdade situada, a tese canónica provisória é a seguinte: A liberdade não é exterior ao real nem puro epifenómeno; é liberdade situada no poder-ser real de um agente encarnado.

### Articulação estrutural
proposições nucleares: P04, P05, P07, P08, P36, P38; pontes entre níveis: PN01, PN04; ancoragens científicas: AC01; campos do real: CR01
...
- **n_fragmentos_com_tratamento_filosofico**: 318
...
- **P36** — fragmentos: 292, registos de impacto: 0
- **P38** — fragmentos: 48, registos de impacto: 0
...
- fragmentos: 292 | microlinhas: 87 | ramos: 21 | percursos: 3 | argumentos: 16

### P38
A ação humana constitui atualização real situada, inscrita em campos e portadora de efeitos reais.
- fragmentos: 48 | microlinhas: 13 | ramos: 9 | percursos: 3 | argumentos: 13
...
```json
{
  "descricao_funcional_curta": "Critica uma decomposição insuficiente do real em causas compartimentadas.",
...
```json
{
  "descricao_funcional_curta": "Diagnostica a autonomização de estruturas intelectuais como substituição prática do real.",
  "problema_filosofico_central": "substituicao_do_real_pelo_sistema",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Critica a elevação da apreensão subjetiva a fundamento do real.",
  "problema_filosofico_central": "adequacao_entre_representacao_e_real",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Critica um sistema que fecha a liberdade e redefine o mérito fora do real.",
  "problema_filosofico_central": "substituicao_do_real_pelo_sistema",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Diagnóstico político da confusão entre sistema e real.",
  "problema_filosofico_central": "substituicao_do_real_pelo_sistema",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
Mas o homem faz coisas tão más, é tão mauzão. Olha o Hitler. Claro. Hitler e qualquer outro massacre, qualquer outra guerra, que não falta por aí são guerras.

Aquela foi com uma dimensão ridícula, mas ao.de extermínio. Mas outros extermínios também existiram, ainda que com dimensões menores. Mas independentemente da catástrofe, dizer como é que é possível... Nós sabemos como é que é possível.

#### Tratamento filosófico
```json
{
  "descricao_funcional_curta": "Abre a questão da possibilidade do mal extremo.",
  "problema_filosofico_central": "responsabilidade_ontologica",
  "trabalho_no_sistema": "abre_problema_ontologico",
  "confianca_tratamento_filosofico": "media"
}
```
...
```json
{
  "descricao_funcional_curta": "Diagnostica justificação sistémica do dano fora do real.",
  "problema_filosofico_central": "substituicao_do_real_pelo_sistema",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Recusa equivalência entre critérios e fixa a adequação ao real como medida.",
  "problema_filosofico_central": "criterio_de_verdade",
  "trabalho_no_sistema": "fixa_criterio_de_verdade",
  "confianca_tratamento_filosofico": "alta"
}
...
```json
{
  "descricao_funcional_curta": "Reordena o percurso pelo objeto e pelo vínculo ao real.",
  "problema_filosofico_central": "ordem_do_percurso_filosofico",
...
- **ML_0017** — critica sistemica e reintegracao — prepara: erro descritivo
...
- **ML_0136** — epistemologia — introduz: substituicao do real pelo sistema
...
- **ML_0182** — nao_determinado — introduz: responsabilidade ontologica
- **ML_0183** — epistemologia — prolonga: substituicao do real pelo sistema
...
- **RA_0004** — critica sistemica e reintegracao — erro descritivo — prepara (sem impacto relevante)
...
- **RA_0045** — epistemologia — substituicao do real pelo sistema — introduz (explicita)
...
- **RA_0063** — epistemologia — responsabilidade ontologica — introduz (sem impacto relevante)
