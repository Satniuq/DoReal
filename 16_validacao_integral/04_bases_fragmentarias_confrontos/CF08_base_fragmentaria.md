# CF08 — Base fragmentária reaberta
...
### Pergunta central
Como surge algo qualitativamente novo no real sem milagre nem redução empobrecedora?

### Tese canónica provisória
Quanto a causalidade, emergência e passagem de níveis, a tese canónica provisória é a seguinte: o surgimento de níveis qualitativamente novos no real não exige ruptura de substância nem milagre causal; exige antes reorganizações materiais e relacionais suficientemente determinadas para tornarem possível uma nova forma de unidade funcional, cuja inteligibilidade depende de continuidade ontológica, mediação real e irredutibilidade regional de regime.

### Articulação estrutural
proposições nucleares: P04, P05, P07, P08, P16, P18, P19, P23, P27, P28, P29, P30, P31; pontes entre níveis: PN02, PN03, PN04; ancoragens científicas: AC01, AC02; campos do real: CR02, CR05, CR06

## 3. Estatísticas de reabertura
- **n_proposicoes_dossier**: 13
- **n_proposicoes_localizadas**: 13
- **n_fragmentos**: 490
- **n_microlinhas**: 165
- **n_ramos**: 45
- **n_percursos**: 17
...
- **n_fragmentos_com_tratamento_filosofico**: 487

## 4. Cobertura por proposição
- **P04** — fragmentos: 4, registos de impacto: 0
- **P05** — fragmentos: 0, registos de impacto: 0
- **P07** — fragmentos: 1, registos de impacto: 0
- **P08** — fragmentos: 0, registos de impacto: 0
- **P16** — fragmentos: 16, registos de impacto: 0
- **P18** — fragmentos: 29, registos de impacto: 0
- **P19** — fragmentos: 18, registos de impacto: 0
- **P23** — fragmentos: 145, registos de impacto: 0
...
### P04
Toda a distinção implica uma relação mínima de não-identidade entre termos distinguíveis.
- fragmentos: 4 | microlinhas: 3 | ramos: 3 | percursos: 17 | argumentos: 6

### P05
A estabilização relacional de diferenças constitui estrutura como condição de determinabilidade.
- fragmentos: 0 | microlinhas: 0 | ramos: 0 | percursos: 17 | argumentos: 2

### P07
Determinação é fixação relacional sob limite; ser algo é ser delimitadamente.
- fragmentos: 1 | microlinhas: 1 | ramos: 1 | percursos: 16 | argumentos: 6

### P08
Toda a determinação envolve exclusão do que ela não é.
- fragmentos: 0 | microlinhas: 0 | ramos: 0 | percursos: 17 | argumentos: 2

### P16
Movimento e estabilidade são co-possíveis porque a continuidade estruturada admite transição e manutenção sob limite.
- fragmentos: 16 | microlinhas: 6 | ramos: 6 | percursos: 15 | argumentos: 12

### P18
As determinações e atualizações reais distribuem-se em configurações relacionais relativamente estáveis, isto é, em campos.
- fragmentos: 29 | microlinhas: 8 | ramos: 8 | percursos: 13 | argumentos: 13

### P19
Os campos admitem estabilizações funcionais locais sem exigirem fechamento absoluto do real.
- fragmentos: 18 | microlinhas: 6 | ramos: 5 | percursos: 10 | argumentos: 12

### P23
Todo o ente se encontra situado no real e nenhuma apreensão ocorre a partir de um exterior ao real.
- fragmentos: 145 | microlinhas: 47 | ramos: 15 | percursos: 13 | argumentos: 22
...
```json
{
  "descricao_funcional_curta": "Levanta de modo vacilante o problema consciência-matéria e esboça alternativas sem decisão.",
  "problema_filosofico_central": "origem_da_consciencia",
  "trabalho_no_sistema": "abre_problema_ontologico",
  "confianca_tratamento_filosofico": "baixa"
}
...
```json
{
  "descricao_funcional_curta": "Objecção à redução particulista da consciência.",
  "problema_filosofico_central": "consciencia_como_processo_no_real",
  "trabalho_no_sistema": "desfaz_confusao_categorial",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Diagnóstico da autoprivilegiação sistémica contra o real.",
  "problema_filosofico_central": "substituicao_do_real_pelo_sistema",
  "trabalho_no_sistema": "identifica_substituicao_do_real",
  "confianca_tratamento_filosofico": "media"
}
...
```json
{
  "descricao_funcional_curta": "Exemplo prático e ainda impreciso sobre manutenção de condições e foco na condução.",
  "problema_filosofico_central": "regularidade_e_estabilidade",
  "trabalho_no_sistema": "abre_aplicacao_setorial",
  "confianca_tratamento_filosofico": "baixa"
}
...
```json
{
  "descricao_funcional_curta": "Descreve a atualização relacional do real potencial.",
  "problema_filosofico_central": "potencialidade_e_atualizacao",
  "trabalho_no_sistema": "descreve_dinamica_ontologica",
  "confianca_tratamento_filosofico": "media"
}
...
- **ML_0110** — transicao antropologica — introduz: origem da consciencia
- **ML_0111** — epistemologia — introduz: erro de escala
- **ML_0112** — critica sistemica e reintegracao — prolonga: substituicao do real pelo sistema
...
- **ML_0115** — nao_determinado — introduz: regularidade e estabilidade
...
- **ML_0185** — estrutura operacional do real — prolonga: potencialidade e atualizacao
...
- **RA_0034** — nao_determinado — regularidade e estabilidade — introduz (sem impacto relevante)
...
- **RA_0065** — estrutura operacional do real — potencialidade e atualizacao — prolonga (explicita)
...
- **ARG_CAMPO_COMO_CONFIGURACAO_RELACIONAL** — conceito_alvo: D_CAMPO | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_CIRCULO_COMO_FECHO_FUNCIONAL_LOCAL** — conceito_alvo: D_CIRCULO | natureza: meta_dedutivo | criterio_ultimo: D_REAL
...
- **ARG_CONTINGENCIA_COMO_RESIDUO_ESTRUTURAL_DA_POTENCIA** — conceito_alvo: D_CONTINGENCIA | natureza: meta_dedutivo | criterio_ultimo: D_REAL
...
- **ARG_LIBERDADE_SITUADA_COMO_ORIENTACAO_NO_PODER_SER** — conceito_alvo: D_LIBERDADE_SITUADA | natureza: meta_dedutivo | criterio_ultimo: D_REAL
...
- **ARG_NECESSIDADE_COMO_DECORRENCIA_DO_LIMITE** — conceito_alvo: D_NECESSIDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_PODER_SER_COMO_DIMENSAO_REAL_DA_ESTRUTURA** — conceito_alvo: D_PODER_SER | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_POTENCIALIDADE_COMO_CAMPO_DE_ATUALIZACOES_COMPATIVEIS** — conceito_alvo: D_POTENCIALIDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_REAL_COMO_CONTINUIDADE_ESTRUTURADA** — conceito_alvo: D_REAL | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_REGULARIDADE_COMO_ESTABILIDADE_RELACIONAL** — conceito_alvo: D_REGULARIDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
...
- **ARG_RESPONSABILIDADE_EXIGE_LOCALIDADE_E_PONTO_DE_VISTA** — conceito_alvo: D_RESPONSABILIDADE_ONTOLOGICA | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_RESPONSABILIDADE_ONTOLOGICA_COMO_RESPOSTA_A_DANO_REAL** — conceito_alvo: D_RESPONSABILIDADE_ONTOLOGICA | natureza: meta_dedutivo | criterio_ultimo: D_REAL
...
- **ARG_VALIDADE_COMO_ESTABILIDADE_DE_APLICACAO** — conceito_alvo: D_VALIDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_VERDADE_COMO_ADEQUACAO_SOB_CRITERIO** — conceito_alvo: D_VERDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
- **ARG_VERDADE_EXIGE_SUBMISSAO_REAL** — conceito_alvo: D_VERDADE | natureza: meta_dedutivo | criterio_ultimo: D_REAL
