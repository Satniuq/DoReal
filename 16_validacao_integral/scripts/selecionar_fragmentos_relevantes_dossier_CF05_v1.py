...
DEFAULT_HINTS = [
    'humano situado', 'ente localizado', 'localidade', 'localização', 'localizacao',
    'apreensão', 'apreensao', 'relação situada com o real', 'relacao situada com o real',
    'memória', 'memoria', 'temporalidade interna', 'estabilização interna', 'estabilizacao interna',
    'representação', 'representacao', 'mediação', 'mediacao', 'símbolo', 'simbolo', 'linguagem',
    'consciência', 'consciencia', 'autoconsciência', 'autoconsciencia', 'presença de si', 'presenca de si',
    'consciência', 'consciencia', 'reflexividade', 'identidade', 'continuidade', 'retenção', 'retencao', 'protensão', 'protensao', 'adequação', 'adequacao', 'verdade', 'erro', 'correção', 'correcao',
    'reinscrição no real', 'reinscricao no real', 'tempo vivido', 'identidade narrativa'
]

PROFILE_CONFIGS: Dict[str, Dict[str, Any]] = {
    'humano_situado_localidade_apreensao': {
        'label': 'Humano situado, localidade e apreensão',
        'description': 'Solo ontológico-local do confronto: ente situado no real, reinscrição do humano e apreensão situada.',
        'hints': [
            'ente situado', 'ente localizado', 'humano situado', 'ser humano', 'humano reinscrito', 'reinscrito no real',
            'localidade', 'localização', 'localizacao', 'situado no real', 'localizado no real', 'no real',
            'apreensão', 'apreensao', 'apreender', 'relação situada com o real', 'relacao situada com o real',
            'relação com o real', 'relacao com o real', 'nada apreende de fora do real', 'humano no real', 'encarnado'
        ],
        'boost_terms': ['human', 'local', 'situad', 'apree', 'real', 'ente', 'reins'],
        'anti_hints': ['identidade narrativa', 'tempo vivido puro', 'substância do eu', 'substancia do eu']
    },
    'memoria_temporalidade_estabilizacao_interna': {
        'label': 'Memória, temporalidade e estabilização interna',
        'description': 'Núcleo provável do CF05: memória como estabilização temporal interna da relação ao real.',
        'hints': [
            'memória', 'memoria', 'temporal', 'tempo', 'temporalidade', 'temporalidade interna', 'estabilização temporal', 'estabilizacao temporal',
            'estabilização interna', 'estabilizacao interna', 'continuidade interna', 'continuidade temporal', 'retenção', 'retencao',
            'retenção temporal', 'retenção do vivido', 'retenção operativa', 'retencao operativa', 'passado', 'duração interna', 'duracao interna',
            'memória operativa', 'memória interna', 'inscrição durável', 'inscricao duravel', 'estabilização do vivido', 'estabilizacao do vivido'
        ],
        'boost_terms': ['memor', 'tempor', 'tempo', 'reten', 'estab', 'conti', 'durac', 'passad'],
        'anti_hints': ['erro de escala']
    },
    'continuidade_retencao_protensao_identidade': {
        'label': 'Continuidade, retenção, protensão e identidade',
        'description': 'Camada de continuidade de si, identidade no tempo, retenção/protensão e eventual identidade narrativa.',
        'hints': [
            'continuidade', 'continuidade de si', 'continuidade pessoal', 'identidade', 'identidade no tempo', 'identidade temporal',
            'identidade narrativa', 'retenção', 'retencao', 'protensão', 'protensao', 'retenção e protensão', 'retencao e protensao',
            'presença de si', 'presenca de si', 'permanência', 'permanencia', 'mesmo eu', 'si mesmo ao longo do tempo', 'unidade de experiência', 'unidade de experiencia'
        ],
        'boost_terms': ['identi', 'conti', 'reten', 'proten', 'presen', 'perm'],
        'anti_hints': ['arquivo neutro', 'mero registo', 'mera estabilização', 'mera estabilizacao']
    },
    'representacao_mediacao_simbolo_linguagem': {
        'label': 'Representação, mediação, símbolo e linguagem',
        'description': 'Transformação da memória/apreensão em representação operável e mediações simbólico-linguísticas.',
        'hints': [
            'representação', 'representacao', 'representar', 'mediação', 'mediacao', 'símbolo', 'simbolo', 'linguagem', 'signo',
            'fixação', 'fixacao', 'operável', 'operavel', 'representação operável', 'representacao operavel', 'mediação simbólica', 'mediacao simbolica',
            'campo simbólico', 'campo simbolico', 'nomeação', 'nomeacao', 'tradução simbólica', 'traducao simbolica'
        ],
        'boost_terms': ['repre', 'media', 'simbo', 'lingu', 'sign', 'fixac', 'nomea'],
        'anti_hints': ['substância do eu', 'substancia do eu']
    },
    'consciencia_reflexividade_identidade_pessoal': {
        'label': 'Consciência, reflexividade e identidade pessoal',
        'description': 'Camada alta do dossier: consciência, reflexividade, continuidade de si e identidade pessoal.',
        'hints': [
            'consciência', 'consciencia', 'consciência reflexiva', 'consciencia reflexiva', 'autoconsciência', 'autoconsciencia',
            'reflexividade', 'reflexivo', 'identidade pessoal', 'eu', 'si mesmo', 'subjetividade', 'subjetivo', 'presença de si', 'presenca de si',
            'autorrelação', 'autorrelacao', 'continuidade de si', 'estatuto do sujeito', 'sujeito'
        ],
        'boost_terms': ['consc', 'refle', 'autoc', 'subje', 'autor', 'identi'],
        'anti_hints': ['mera retenção', 'mera retencao', 'estabilização impessoal', 'estabilizacao impessoal']
    },
    'adequacao_erro_correcao_reinscricao_no_real': {
        'label': 'Adequação, erro, correção e reinscrição no real',
        'description': 'Prolongamento corretivo: memória, representação e consciência submetidas ao real, com possibilidade de erro e correção.',
        'hints': [
            'adequação', 'adequacao', 'desadequação', 'desadequacao', 'verdade', 'erro', 'correção', 'correcao', 'reinscrição no real', 'reinscricao no real',
            'submissão ao real', 'submissao ao real', 'ajustamento ao real', 'desajustamento', 'ajuste ao real', 'critério', 'criterio',
            'erro categorial', 'erro de escala', 'correção pelo real', 'correcao pelo real'
        ],
        'boost_terms': ['adequa', 'verda', 'erro', 'corre', 'reins', 'crite', 'ajust'],
        'anti_hints': ['tempo vivido puro', 'identidade sem real']
    },
}
...
def build_overlap_signals(sample_global: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    cf04_like = (
        counts.get('humano_situado_localidade_apreensao', 0) +
        counts.get('memoria_temporalidade_estabilizacao_interna', 0) +
        counts.get('representacao_mediacao_simbolo_linguagem', 0)
    ) / total
    cf07_like = (
        counts.get('representacao_mediacao_simbolo_linguagem', 0) +
        counts.get('adequacao_erro_correcao_reinscricao_no_real', 0)
    ) / total
    corridor_like = (
        counts.get('memoria_temporalidade_estabilizacao_interna', 0) +
        counts.get('continuidade_retencao_protensao_identidade', 0) +
        counts.get('representacao_mediacao_simbolo_linguagem', 0) +
        counts.get('consciencia_reflexividade_identidade_pessoal', 0)
    ) / total
    high_identity_pull = (
        counts.get('continuidade_retencao_protensao_identidade', 0) +
        counts.get('consciencia_reflexividade_identidade_pessoal', 0)
    ...
    notes: List[str] = []
    if cf04_like >= 0.45:
        notes.append('Há tração relevante para o solo CF04-like: humano situado/localidade + memória + mediação.')
    if cf07_like >= 0.35:
        notes.append('Há tração relevante para a ponta CF07-like: representação/mediação + adequação/erro/correção.')
    if corridor_like >= 0.60:
        notes.append('O sample aproxima-se fortemente do corredor P23–P30: ente situado → humano reinscrito → memória → representação → símbolo → linguagem → consciência reflexiva.')
    if high_identity_pull >= 0.40:
        notes.append('O léxico de continuidade/identidade/reflexividade tem peso não negligenciável no sample.')
    if not notes:
        notes.append('Os sinais de sobreposição arquitetónica existem, mas não aparecem de forma concentrada no sample selecionado.')

    return {
        'cf04_like_share': round(cf04_like, 4),
        'cf07_like_share': round(cf07_like, 4),
        'corridor_p23_p30_share': round(corridor_like, 4),
        'high_identity_share': round(high_identity_pull, 4),
        'notes': notes,
    }
