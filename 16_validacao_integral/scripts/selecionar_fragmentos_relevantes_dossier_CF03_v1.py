...
DEFAULT_HINTS = [
    'vida', 'vivo', 'organismo', 'orgânico', 'organico', 'corpo', 'corporeidade', 'animal', 'animalidade',
    'potencialidade', 'atualização', 'atualizacao', 'continuidade', 'campo', 'processo vivo', 'organização viva', 'organizacao viva',
    'apreensão', 'apreensao', 'deteção', 'detecao', 'localidade', 'local', 'relação ao real', 'relacao ao real', 'interior', 'exterior',
    'ser reflexivo', 'sujeito encarnado', 'encarnação', 'encarnacao', 'consciência', 'consciencia', 'representação', 'representacao',
    'mediação', 'mediacao', 'passagem', 'continuidade sem salto', 'sem dualismo', 'sem reducionismo',
    'dualismo', 'reducionismo', 'erro de escala', 'entre níveis', 'entre niveis', 'níveis de ser', 'niveis de ser'
]

PROFILE_CONFIGS: Dict[str, Dict[str, Any]] = {
    'vida_organismo_corpo_animalidade': {
        'label': 'Vida, organismo, corpo e animalidade',
        'description': 'Eixo da vida organizada, organismo, corpo, animalidade e forma encarnada do viver.',
        'hints': [
            'vida', 'vivo', 'vivente', 'organismo', 'organização viva', 'organizacao viva', 'biológico', 'biologico',
            'corpo', 'corpóreo', 'corporeo', 'corporeidade', 'animal', 'animalidade', 'encarnação', 'encarnacao',
            'sujeito encarnado', 'forma viva', 'forma orgânica', 'forma organica', 'organização do vivo', 'estrutura viva'
        ],
        'boost_terms': ['vida', 'vivo', 'organ', 'corp', 'anim', 'biolog', 'encarn'],
        'anti_hints': ['erro de escala', 'potencialidade pura']
    },
    'potencialidade_atualizacao_continuidade_campo': {
        'label': 'Potencialidade, atualização, continuidade e campo',
        'description': 'Solo ontológico-dinâmico: potencialidade, atualização, continuidade real e campo de transformação.',
        'hints': [
            'potencialidade', 'potência', 'potencia', 'atualização', 'atualizacao', 'actualização', 'actualizacao',
            'continuidade', 'campo', 'passagem', 'transformação', 'transformacao', 'dinâmica', 'dinamica',
            'processo', 'devir', 'virtual', 'atual', 'actual', 'continuidade real', 'campo de potencialidades',
            'sem salto', 'sem salto ilegítimo', 'sem salto ilegitimo'
        ],
        'boost_terms': ['potenc', 'atual', 'actual', 'continu', 'campo', 'dinam', 'devir', 'transfo'],
        'anti_hints': ['dualismo', 'corporeidade']
    },
    'apreensao_detecao_localidade_relacao_ao_real': {
        'label': 'Apreensão, deteção, localidade e relação ao real',
        'description': 'Relação do organismo ao real por deteção, apreensão situada, interior/exterior e localização do vivo.',
        'hints': [
            'apreensão', 'apreensao', 'deteção', 'detecao', 'detetar', 'detectar', 'localidade', 'local',
            'relação ao real', 'relacao ao real', 'interior', 'exterior', 'órgãos sensoriais', 'orgaos sensoriais',
            'ambiente', 'meio', 'apreender', 'contato', 'contacto', 'ingestão', 'ingestao', 'separação', 'separacao',
            'colisão', 'colisao', 'organismo ao real', 'animal no real'
        ],
        'boost_terms': ['apree', 'detec', 'local', 'interi', 'exter', 'ambient', 'sensor', 'contat'],
        'anti_hints': ['potencialidade pura']
    },
    'ser_reflexivo_mediacao_representacao_passagem_sem_dualismo': {
        'label': 'Ser reflexivo, mediação, representação e passagem sem dualismo',
        'description': 'Passagem do vivo/animal ao ser reflexivo encarnado, com mediação representacional sem corte dualista.',
        'hints': [
            'ser reflexivo', 'consciência reflexiva', 'consciencia reflexiva', 'representação', 'representacao',
            'mediação', 'mediacao', 'passagem', 'sujeito encarnado', 'humano', 'animal humano', 'representa o ambiente',
            'vive naquilo que representa', 'sem dualismo', 'passagem sem dualismo', 'diferença sem dualismo', 'diferenca sem dualismo',
            'consciência encarnada', 'consciencia encarnada', 'especificidade do humano', 'continuidade com diferença', 'continuidade com diferenca'
        ],
        'boost_terms': ['reflex', 'repre', 'media', 'passag', 'human', 'consc', 'encarn', 'diferenc'],
        'anti_hints': ['redução fisicalista', 'reducao fisicalista']
    },
    'dualismo_reducionismo_erro_de_escala_entre_niveis': {
        'label': 'Dualismo, reducionismo e erro de escala entre níveis',
        'description': 'Crítica do dualismo e do reducionismo, com atenção a erros de escala e mistura ilegítima de níveis.',
        'hints': [
            'dualismo', 'reducionismo', 'erro de escala', 'mistura de níveis', 'mistura de niveis', 'entre níveis', 'entre niveis',
            'níveis de ser', 'niveis de ser', 'salto ilegítimo', 'salto ilegitimo', 'diferença de modo de ser', 'diferenca de modo de ser',
            'não reduzir', 'nao reduzir', 'não separar', 'nao separar', 'passagem ilegítima', 'passagem ilegitima',
            'escala errada', 'troca de nível', 'troca de nivel'
        ],
        'boost_terms': ['dualis', 'reduc', 'escala', 'nivel', 'salt', 'separ', 'mistur', 'diferenc'],
        'anti_hints': ['organização viva', 'organizacao viva']
    },
}
...
def build_markdown(
    ...
    lines: List[str] = []
    lines.append(f'# {confronto_id} — fragmentos relevantes para o dossier (CF03 v1)')
    lines.append('')
...
def build_report(
    ...
    lines: List[str] = []
    lines.append(f'RELATÓRIO — {confronto_id} (CF03 v1)')
    lines.append('')
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description='Seleciona fragmentos relevantes para o dossier CF03, com score global robusto, perfis paralelos e diagnóstico de alinhamento/desalinhamento.'
    )
